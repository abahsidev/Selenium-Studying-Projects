...
public class _17_4_Alerts_promptButton {
...
//        String url = scanner.nextLine();
        ...
        driver.switchTo().alert().sendKeys("I was here ");
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        driver.switchTo().alert().accept();

        WebElement getTextThatSent = driver.findElement(By.id("promptResult"));
        System.out.println(getTextThatSent.getText());
        driver.quit();
    }
}
